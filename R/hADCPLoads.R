...
#' @param InputData List generated by import_data.R
...
Site <- InputData$Site
ADCP <- InputData$ADCP
Echo_Intensity_Beam_1 <- InputData$Echo_Intensity_Beam_1
Echo_Intensity_Beam_2 <- InputData$Echo_Intensity_Beam_2 # example code assumes backscatter is equal across beams
...
# legend("topright",legend = c("Estimated concentration", "Actual concentration"), lty = c(0, 0),col = c(2, 1),pch = c(1,21))
#
# # Flux plot
...
# legend("topright",legend = c("Estimated analyte flux", "Actual analyte flux"), lty = c(0, 0),col = c(2, 1),pch = c(1,21))
#
