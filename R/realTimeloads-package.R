...
#'
#'\code{\link{ExampleCode}} Process acoustic backscatter from synthetic data detailed in Appendix B of the Guideline
#'
...
#'
#'@author Daniel Livsey (2023), livsey.daniel@@gmail.com, ORCID: 0000-0002-2028-6128
#' @keywords internal
"_PACKAGE"
